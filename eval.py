...
def eval_FROC(gt_boxes, all_boxes, CLASSES, avgFP=[0.05, 0.1, 0.2], iou_th=0.5):
    ...
    for cls in range(len(all_boxes)):
        ...
        lh_tmp.append(result.tolist())
        for idx, recall in enumerate(result):
...
def main():
    ...
    test_json = 'valid_x-ray.json'
    pred_dir = 'val_mmdetection'
...
if __name__ == '__main__':
    # print(IOU(np.array([620,342,871,649]),np.array([[568,394,880,546]])))
    main()